...
export function ReleaseControlPage({ snapshot }: { snapshot: ReleaseSnapshot }) {
  const filter: ReviewFilter = 'all';
  // TODO 04: rendi locale il filtro e deriva visibleChecks.
  const visibleChecks = snapshot.checks;
      ...
      <Box component="main" id="main-content">
        <Container maxWidth="lg" sx={{ py: { xs: 3, sm: 5 } }}>
          <Box
            sx={{
              display: 'grid',
              gridTemplateColumns: { xs: '1fr', md: 'minmax(0, 1.75fr) minmax(280px, 0.75fr)' },
              alignItems: 'start',
              gap: 3,
            }}
          >
            ...
            >
              <Stack spacing={2.5}>
                <Box>
                  <Typography id="release-checks-heading" component="h2" variant="h2">
